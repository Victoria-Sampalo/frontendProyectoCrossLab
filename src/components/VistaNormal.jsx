  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>Fecha de nacimiento: {new Date(logged.user.date_of_birth).toLocaleDateString()}</li>
        <li>Fecha de registro: {new Date(logged.user.registration_date).toLocaleDateString()}</li>
      </ul>
